...
def keypad():
    ...
    columns = [["head", "triforce", "lambda", "lightning", "alien", "H", "backc"], ["backe", "head", "backc", "e", "stare", "H", "?"], ["copyright", "w", "e", "K", "R",
                                                                                                                                        "lambda", "stare"], ["6", "P", "b", "alien", "K", "?", "face"], ["trident", "face", "b", "c", "P", "3", "starf"], ["6", "backe", "puzzle", "ae", "trident", "N", "omega"]]
...
def wof():
    for q in range(5):
        ...
        # input display
        disp = input(
            "What does the display say? (enter 'b' for empty display) ").lower()
...
def compwires():
    ...
    while True:
        ...
        white = True if int(
            input("Is the wire just white? (0/1) ")) == 1 else False
            ...
            if (not star) and (not led):
                ...
                if red and blue:  # red + blue
                    if star and led:
                        ...
                        print("Cut") if lastdigit == "even" else print(
                            "Don't cut")
...
def wireseqs():
    ...
    while True:
        ...
        while not foundcolour:
            ...
            wire = input(
                "Enter the color and letter separated by a space or 'e' to stop: ").lower().split()
            if wire[0] == 'e':
                reds = 0
                blues = 0
                blacks = 0
...
def password():
    first = list(
        input("Enter the letters for the first letter of the password: "))
    second = list(
        input("Enter the letters for the second letter of the password: "))
    third = list(
        input("Enter the letters for the third letter of the password: "))
    fourth = list(
        input("Enter the letters for the fourth letter of the password: "))
    fifth = list(
        input("Enter the letters for the fifth letter of the password: "))

    words = ['about', 'after', 'again', 'below', 'could', 'every', 'first', 'found', 'great', 'house', 'large', 'learn', 'never', 'other', 'place', 'plant', 'point',
